...
! function(t, e) {
	...
	return function(t) {
			...
			f = function(t) {
				...
				return i(e, t), a(e, [{
					...
					value: function(t) {
						...
						return t = this.sanitize(t), n.setAttribute("href", t), n.setAttribute("target", "_blank"), n.id = "link", n
					}
				}, {
					key: "formats",
					value: function(t) {
		...
		var l = function() {
			...
			c = {
				scope: u.default.Scope.INLINE,
				whitelist: ['Microsoft-YaHei', 'SimSun', 'SimHei', 'KaiTi', 'FangSong', 'Arial', 'Times-New-Roman', 'sans-serif']
			},
		...
		var r = n(0),
			...
			i = new o.default.Attributor.Class("size", "ql-size", {
				scope: o.default.Scope.INLINE,
				whitelist: ['10px', '12px', '14px', '16px' ,'18px', '20px', '22px', '24px', '26px', '32px', '48px', "60px", "72px", "96px", "144px", "180px", "225px"]
			}),
				...
				toolbar: {
					handlers: {
						...
						image: function() {
							...
							t.quill.updateContents((new d.default).retain(r.index).delete(r.length).insert({
								image: "   " // 三个空格
							}), v.default.sources.USER), t.quill.setSelection(r.index + 1, v.default.sources.SILENT);
						},
						video: function() {
		...
		var M = function(t) {
			...
			return l(e, t), u(e, [{
				...
				value: function() {
					...
					this.root.classList.add("ql-editing"), null != e ? this.textbox.value = e : t !== this.root.getAttribute("data-mode") && (this.textbox.value = ""), this.position(this.quill.getBounds(this.quill.selection.savedRange)), this.textbox.select(), this.textbox.setAttribute("placeholder", this.textbox.getAttribute("data-" + t) || ""), this.root.setAttribute("data-mode", t)
				}
			}, {
				key: "restoreFocus",
				value: function() {
		...
		var s = function() {
			...
			x = function(t) {
				...
				return l(e, t), u(e, [{
					...
					key: "insertBefore",
					value: function(t, n) {
						if( t.domNode.className === "ql-video" ) {
							t.domNode.id = 'video';
							t.domNode.innerHTML = `
								<video onloadeddata="show_first_frame(this);" controls>
                    				<source src="${t.domNode.getAttribute('src')}" type="video/mp4">
                    				浏览器不支持视频播放
                				</video>							`
						}
		...
		var l = function() {
			...
			h = function(t) {
				...
				return i(e, t), l(e, [{
					...
					value: function(t) {
						var n = a(e.__proto__ || Object.getPrototypeOf(e), "create", this).call(this, t);
						return n.setAttribute("src", this.sanitize(t)), n
					}
				}, {
					key: "formats",
					value: function(t) {
		...
		h.blotName = "video", h.className = "ql-video", h.tagName = "p", e.default = h
	}, function(t, e, n) {
		"use strict";
